...
class PerceptualNet_multilayer(nn.Module):
    def __init__(self, opt):
        super(PerceptualNet_multilayer, self).__init__()
        self.vgg = create_perceptualnet(opt)
        self.conv2_2 = []
        self.conv3_3 = []
        self.conv4_3 = []
        self.conv5_3 = []
